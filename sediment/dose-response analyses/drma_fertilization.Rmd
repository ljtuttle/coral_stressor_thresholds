...
ES_adult %>% count(Gsp) #n=4 species
ES_adult %>% count(Updated_Genus)
ES_immat %>% count(Gsp) #n=4 species
...
ggplot(ES_SS_fertilization2, 
  ...
  theme_classic() +
  scale_x_log10(limits = c(0.1,150), breaks=c(0.1,1,10,100), 
...
#All models with 'a' or 'c' at the end of its name have fixed slopes, random intercepts.
#All models with 'b' or 'd' at the end of its name have random slopes and intercepts.

# LINEAR FIXED AND RANDOM EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_1a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Comparison,
                       data = ES_SS_fertilization2, method = "ml")
mod_SS_fertil_1b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
...
mod_SS_fertil_2a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
mod_SS_fertil_2b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_3a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref_name/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
mod_SS_fertil_3b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_4a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
mod_SS_fertil_4b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
...
mod_SS_fertil_5a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT))
mod_SS_fertil_5b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT))
...
mod_SS_fertil_6a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Ref/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT2))
mod_SS_fertil_6b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Ref/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT2))
...
mod_SS_fertil_7a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Ref_name/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT3))
mod_SS_fertil_7b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Ref_name/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT3))
...
```{r, echo=FALSE, warning=FALSE}
# Model Comparisons
AIC(mod_SS_fertil_1a, mod_SS_fertil_2a, mod_SS_fertil_3a, mod_SS_fertil_4a, mod_SS_fertil_5a, mod_SS_fertil_6a, mod_SS_fertil_7a, mod_SS_fertil_1b, mod_SS_fertil_2b, mod_SS_fertil_3b, mod_SS_fertil_4b, mod_SS_fertil_5b, mod_SS_fertil_6b, mod_SS_fertil_7b) 
#of these, model 2b has lowest AIC (but 6b within 2 AIC)
...
resid_b <- resid(mod_SS_fertil_2b)
fitted_b <- fitted(mod_SS_fertil_2b)
plot(fitted_b, resid_b, main = "smd ~ mg_d_L, S = vmd,
     random =  ~ mg_d_L | Ref/Comparison")
abline(0,0)
#mod_SS_fertil_1a and mod_SS_fertil_3a were within 2 AIC

resid_b2 <- resid(mod_SS_fertil_6b)
fitted_b2 <- fitted(mod_SS_fertil_6b)
plot(fitted_b2, resid_b2, main = "B: smd ~ mg_d_L, control = addSlist,
     random =  ~ mg_d_L | Ref/Comparison")
abline(0,0)
#mod_SS_fertil_6b within 1 AIC
...
# Patterns:
# 1.  Residuals for all best-fit models are very similar.
# 2.  There could be non-linearities that need to be accounted for.
# 3.  Very strong outlier in negative residual land!
...
# LINEAR FIXED AND RANDOM EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_1a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Comparison,
                       data = ES_SS_fertilization2, method = "ml")
log_mod_SS_fertil_1b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Comparison,
                      data = ES_SS_fertilization2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_2a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
log_mod_SS_fertil_2b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison,
                      data = ES_SS_fertilization2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_3a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref_name/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
log_mod_SS_fertil_3b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Ref_name/Comparison,
                      data = ES_SS_fertilization2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_4a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
log_mod_SS_fertil_4b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ log10(Sed_exposure_mg_d_L) | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization2, method = "ml")
...
log_mod_SS_fertil_5a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log))
log_mod_SS_fertil_5b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log))
...
log_mod_SS_fertil_6a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Ref/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log2))
log_mod_SS_fertil_6b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log2))
...
log_mod_SS_fertil_7a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Ref_name/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log3))
log_mod_SS_fertil_7b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Ref_name/Comparison,
                       data=ES_SS_fertilization2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log3))
...
```{r, echo=FALSE, warning=FALSE}
# Model Comparisons
AIC(log_mod_SS_fertil_1a, log_mod_SS_fertil_2a, log_mod_SS_fertil_3a, log_mod_SS_fertil_4a, log_mod_SS_fertil_5a, log_mod_SS_fertil_6a, log_mod_SS_fertil_7a, log_mod_SS_fertil_1b, log_mod_SS_fertil_2b, log_mod_SS_fertil_3b, log_mod_SS_fertil_4b, log_mod_SS_fertil_5b, log_mod_SS_fertil_6b, log_mod_SS_fertil_7b) 
#of these, model 2b has lowest AIC (but 6b,3b,7b within 2 AIC)
...
resid_logb <- resid(log_mod_SS_fertil_2b)
fitted_logb <- fitted(log_mod_SS_fertil_2b)
plot(fitted_logb, resid_logb, main = "smd ~ log_mg_d_L, S = vmd,
     random =  ~ log_mg_d_L | Ref/Comparison")
abline(0,0)

resid_logb2 <- resid(log_mod_SS_fertil_6b)
fitted_logb2 <- fitted(log_mod_SS_fertil_6b)
plot(fitted_logb2, resid_logb2, main = "smd ~ log_mg_d_L, control=addSlist,
     random =  ~ log_mg_d_L | Ref/Comparison")
abline(0,0)
...
log_mg_d_L <- log10(ES_SS_fertilization2$Sed_exposure_mg_d_L)
summary(log_mg_d_L)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#-0.4559  0.5367  0.9785  0.9656  1.5051  2.1072 
...
log_mod_SS_fertil_NL2b <- mixmeta(smd ~ ns(log_mg_d_L, knots = c(0.5367,1.5051)), 
                         random = ~ ns(log_mg_d_L, knots = c(0.5367,1.5051)) | Ref/Comparison, 
                         data = ES_SS_fertilization2, method = "ml", S = vmd)
log_mod_SS_fertil_NL6b <- mixmeta(smd ~ ns(log_mg_d_L, knots = c(0.5367,1.5051)), 
                         random = ~ ns(log_mg_d_L, knots = c(0.5367,1.5051)) | Ref/Comparison, 
                         data = ES_SS_fertilization2, method = "ml",
                         control=list(addSlist=newlist_FERT_log2))
...
log_mod_SS_fertil_NL2a_2 <- update(log_mod_SS_fertil_NL2b, random = ~ log_mg_d_L | Ref/Comparison)
log_mod_SS_fertil_NL6b_2 <- update(log_mod_SS_fertil_NL6b, random = ~ log_mg_d_L | Ref/Comparison)
log_mod_SS_fertil_NL3c_2 <- update(log_mod_SS_fertil_NL3d, random = ~ log_mg_L | Ref_name/Comparison)
log_mod_SS_fertil_NL2d_2 <- update(log_mod_SS_fertil_NL2d, random = ~ log_mg_L | Ref/Comparison)

AIC(log_mod_SS_fertil_NL2b, log_mod_SS_fertil_NL2b_2, log_mod_SS_fertil_NL6b, log_mod_SS_fertil_NL6b_2) #NL6b
...
new_resid_b <- resid(log_mod_SS_fertil_NL2b_2)
new_fitted_b <- fitted(log_mod_SS_fertil_NL2b_2)
plot(new_fitted_b, new_resid_b, main = "smd ~ ns(log_mg_d_L), S = vmd,
     random =  ~ log_mg_d_L | Ref/Comparison")
abline(0,0)

new_resid_b2 <- resid(log_mod_SS_fertil_NL6b)
new_fitted_b2 <- fitted(log_mod_SS_fertil_NL6b)
plot(new_fitted_b2, new_resid_b2, main = "smd ~ ns(log_mg_d_L), control=addSlist,
     random =  ~ ns(log_mg_d_L) | Ref/Comparison")
abline(0,0)
...
#### i. Cumulative exposure is PREDICTOR
Now I will predict the effect size along the exposure range and plot with confidence intervals.  

```{r, echo=FALSE, warning=FALSE}
summary(log_mod_SS_fertil_2b)

# PREDICT THE EFFECT SIZE AND PLOT WITH CONFIDENCE INTERVALS
pred_log_mod_SS_fertil_2b <- predict(log_mod_SS_fertil_2b, newdata=ES_SS_fertilization2, ci=TRUE)
ES_SS_fertilization2_CI2 <- cbind(ES_SS_fertilization2, pred_log_mod_SS_fertil_2b)
#head(ES_SS_fertilization2_CI2)
min_exp_b <- ES_SS_fertilization2_CI2 %>% 
...
ggplot(ES_SS_fertilization2_CI2, 
       aes(x = Sed_exposure_mg_d_L,
           y = smd,
           color = Ref,
           ymin = smd-vmd,
  ...
  geom_pointrange() +
  labs(x = "Sediment cumulative exposure (mg x day/L)",
       y = expression("Effect size (Hedges'"~italic(d)~"+/- s.d.)"),
       color = "Study") +
  geom_abline(intercept=0, slope=0) +
  ...
  theme_classic() +
  scale_x_log10(limits = c(0.1,150), breaks=c(0.1,1,10,100,min_exp_b2), 
                label=c("0.1","1","10","100",round(min_exp_b2, digits = 1)))
```
  
#### ii. Exposure concentration is PREDICTOR
Now I will predict the effect size along the exposure range and plot with confidence intervals.  
...
#CUMULATIVE EXPOSURE vs. effect size, by SEDIMENT TYPE
#Using previously calculated Hedges' d and variance of d
ggplot(ES_SS_fertilization_b2, 
       aes(x = Sed_level_standardized,
           y = smd,
...
#CUMULATIVE EXPOSURE vs. effect size, by PHYLOGENY
#Using previously calculated Hedges' d and variance of d
ggplot(ES_SS_fertilization_b2, 
       aes(x = Sed_level_standardized,
           y = smd,
...
#CUMULATIVE EXPOSURE vs. effect size, by OCEAN and REGION
#Using previously calculated Hedges' d and variance of d
ggplot(ES_SS_fertilization_b2, 
       aes(x = Sed_level_standardized,
           y = smd,
...
# LINEAR FIXED AND RANDOM EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_b_1a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
mod_SS_fertil_b_1b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                      random =  ~ Sed_exposure_mg_d_L | Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_b_2a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
mod_SS_fertil_b_2b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                      random =  ~ Sed_exposure_mg_d_L | Ref/Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_b_3a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref_name/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
mod_SS_fertil_b_3b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                      random =  ~ Sed_exposure_mg_d_L | Ref_name/Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
mod_SS_fertil_b_4a <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ 1 | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
mod_SS_fertil_b_4b <- mixmeta(smd ~ Sed_exposure_mg_d_L, S = vmd,
                       random =  ~ Sed_exposure_mg_d_L | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
...
mod_SS_fertil_b_5a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b))
mod_SS_fertil_b_5b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b))
...
mod_SS_fertil_b_6a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Ref/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b2))
mod_SS_fertil_b_6b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Ref/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b2))
...
mod_SS_fertil_b_7a <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ 1 | Ref_name/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b3))
mod_SS_fertil_b_7b <- mixmeta(smd ~ Sed_exposure_mg_d_L,
                       random = ~ Sed_exposure_mg_d_L | Ref_name/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_b3))
...
```{r, echo=FALSE, warning=FALSE}
# Model Comparisons
AIC(mod_SS_fertil_b_1a, mod_SS_fertil_b_2a, mod_SS_fertil_b_3a, mod_SS_fertil_b_4a, mod_SS_fertil_b_5a, mod_SS_fertil_b_6a, mod_SS_fertil_b_7a, mod_SS_fertil_b_1b, mod_SS_fertil_b_2b, mod_SS_fertil_b_3b, mod_SS_fertil_b_4b, mod_SS_fertil_b_5b, mod_SS_fertil_b_6b, mod_SS_fertil_b_7b) 
#of these, model 2b has lowest AIC (but 6b within 2 AIC)
...
resid_b_b <- resid(mod_SS_fertil_b_2b)
fitted_b_b <- fitted(mod_SS_fertil_b_2b)
plot(fitted_b_b, resid_b_b, main = "B: smd ~ mg_d_L, S = vmd,
     random =  ~ mg_d_L | Ref/Comparison")
abline(0,0)

resid_b_b2 <- resid(mod_SS_fertil_b_6b)
fitted_b_b2 <- fitted(mod_SS_fertil_b_6b)
plot(fitted_b_b2, resid_b_b2, main = "B2: smd ~ mg_d_L, control = addSlist,
     random =  ~ mg_d_L | Ref/Comparison")
abline(0,0)
...
# Patterns:
# 1.  Residuals for all 3 best-fit models are very similar.
# 2.  There could be non-linearities that need to be accounted for?
# 3.  First let's check out a log-transformation of sediment exposure to see if that improves residuals...
```
...
# LINEAR FIXED AND RANDOM EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_b_1a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
log_mod_SS_fertil_b_1b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_b_2a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
log_mod_SS_fertil_b_2b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_b_3a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref_name/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
log_mod_SS_fertil_b_3b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                      random =  ~ log10(Sed_exposure_mg_d_L) | Ref_name/Comparison,
                      data = ES_SS_fertilization_b2, method = "ml")
...
# LINEAR FIXED AND RANDOM, NESTED EFFECTS NOT ACCOUNTING FOR WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_b_4a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ 1 | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
log_mod_SS_fertil_b_4b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L), S = vmd,
                       random =  ~ log10(Sed_exposure_mg_d_L) | Ref_name/Ref/Comparison,
                       data = ES_SS_fertilization_b2, method = "ml")
...
log_mod_SS_fertil_b_5a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b))
log_mod_SS_fertil_b_5b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b))
...
log_mod_SS_fertil_b_6a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Ref/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b2))
log_mod_SS_fertil_b_6b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b2))
...
log_mod_SS_fertil_b_7a <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ 1 | Ref_name/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b3))
log_mod_SS_fertil_b_7b <- mixmeta(smd ~ log10(Sed_exposure_mg_d_L),
                       random = ~ log10(Sed_exposure_mg_d_L) | Ref_name/Comparison,
                       data=ES_SS_fertilization_b2, method="ml", #using dataset without controls
                       control=list(addSlist=newlist_FERT_log_b3))
...
```{r, echo=FALSE, warning=FALSE}
# Model Comparisons
AIC(log_mod_SS_fertil_b_1a, log_mod_SS_fertil_b_2a, log_mod_SS_fertil_b_3a, log_mod_SS_fertil_b_4a, log_mod_SS_fertil_b_5a, log_mod_SS_fertil_b_6a, log_mod_SS_fertil_b_7a, log_mod_SS_fertil_b_1b, log_mod_SS_fertil_b_2b, log_mod_SS_fertil_b_3b, log_mod_SS_fertil_b_4b, log_mod_SS_fertil_b_5b, log_mod_SS_fertil_b_6b, log_mod_SS_fertil_b_7b) 
#of these, model 6b has lowest AIC (but 2b,3b,7b within 2 AIC)
...
resid_log_b_b <- resid(log_mod_SS_fertil_b_2b)
fitted_log_b_b <- fitted(log_mod_SS_fertil_b_2b)
plot(fitted_log_b_b, resid_log_b_b, main = "B: smd ~ log(mg_d_L), S = vmd,
     random =  ~ log(mg_d_L) | Ref/Comparison")
abline(0,0)

resid_log_b_b2 <- resid(log_mod_SS_fertil_b_6b)
fitted_log_b_b2 <- fitted(log_mod_SS_fertil_b_6b)
plot(fitted_log_b_b2, resid_log_b_b2, main = "B2: smd ~ log(mg_d_L), control = addSlist,
     random =  ~ log(mg_d_L) | Ref/Comparison")
abline(0,0)
...
# Normal Q-Q Plot
op <- par(mfrow = c(2,2), mar = c(2,2,4,1))
qqnorm(resid_log_b_b)
qqline(resid_log_b_b)
qqnorm(resid_log_b_b2)
qqline(resid_log_b_b2)
...
# Patterns:
# 1.  Residuals for all 4 best-fit models are very similar.
...
Out of curiosity, I will fit non-linear versions of these logarithmic models, so see if anything improves...
```{r, echo=FALSE, warning=FALSE}
#NON-LINEAR LOGARITHMIC MODELS, IF NEEDED
# Calculate 1st and 3rd quartiles of exposure, to assign 'knots' for non-linear models
log10_mg_d_L <- log10(ES_SS_fertilization_b2$Sed_exposure_mg_d_L)
#summary(log10_mg_d_L)
#    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#-0.4559  0.5185  0.9569  0.9632  1.5051  2.1072 
log10_mg_L <- log10(ES_SS_fertilization_b2$Sed_level_standardized)
#summary(log10_mg_L)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.6021  1.5051  1.9657  1.8844  2.3617  3.0103 

# NON-LINEAR FIXED AND RANDOM EFFECTS ACCOUNTING FOR WITHIN-COMPARISON & WITHIN-STUDY CORRELATIONS
log_mod_SS_fertil_b_NL2b <- mixmeta(smd ~ ns(log10(Sed_exposure_mg_d_L), 
                                                  knots = c(0.5185,1.5051)), 
                         random = ~ ns(log10(Sed_exposure_mg_d_L), 
                                       knots = c(0.5185,1.5051)) | Ref/Comparison, 
                         data = ES_SS_fertilization_b2, method = "ml", S = vmd)
log_mod_SS_fertil_b_NL6b <- mixmeta(smd ~ ns(log10(Sed_exposure_mg_d_L), knots = c(0.5185,1.5051)), 
                         random = ~ ns(log10(Sed_exposure_mg_d_L), 
                                       knots = c(0.5185,1.5051)) | Ref/Comparison, 
                         data = ES_SS_fertilization_b2, method = "ml",
                         control = list(addSlist=newlist_FERT_log_b2))
log_mod_SS_fertil_b_NL3d <- mixmeta(smd ~ ns(log10(Sed_level_standardized), 
                                                  knots = c(1.5051,2.3617)),
                         random = ~ ns(log10(Sed_level_standardized), 
                                       knots = c(1.5051,2.3617)) | Ref_name/Comparison, 
                         data = ES_SS_fertilization_b2, method = "ml", S = vmd)
log_mod_SS_fertil_b_NL2d <- mixmeta(smd ~ ns(log10(Sed_level_standardized), knots = c(1.5051,2.3617)), 
                         random = ~ ns(log10(Sed_level_standardized), 
                                       knots = c(1.5051,2.3617)) | Ref/Comparison, 
                         data = ES_SS_fertilization_b2, method = "ml", S = vmd)

# SIMPLIFY THE MODEL BY ALLOWING NON-LINEARITY ONLY IN FIXED EFFECTS
log_mod_SS_fertil_b_NL2b_2 <- update(log_mod_SS_fertil_b_NL2b, 
                               random = ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison)
log_mod_SS_fertil_b_NL6b_2 <- update(log_mod_SS_fertil_b_NL6b, 
                               random = ~ log10(Sed_exposure_mg_d_L) | Ref/Comparison)
log_mod_SS_fertil_b_NL3d_2 <- update(log_mod_SS_fertil_b_NL3d, 
                               random= ~ log10(Sed_level_standardized) | Ref_name/Comparison)
log_mod_SS_fertil_b_NL2d_2 <- update(log_mod_SS_fertil_b_NL2d, 
                               random= ~ log10(Sed_level_standardized) | Ref/Comparison)

AIC(log_mod_SS_fertil_b_NL2b, log_mod_SS_fertil_b_NL2b_2, log_mod_SS_fertil_b_NL6b, log_mod_SS_fertil_b_NL6b_2) #NL6b
AIC(log_mod_SS_fertil_b_NL3d, log_mod_SS_fertil_b_NL3d_2, log_mod_SS_fertil_b_NL2d, log_mod_SS_fertil_b_NL2d_2) #NL3d_2 or 2d_2
```
...
new_resid_b_b <- resid(log_mod_SS_fertil_b_NL2b_2)
new_fitted_b_b <- fitted(log_mod_SS_fertil_b_NL2b_2)
plot(new_fitted_b_b, new_resid_b_b, main = "B: smd ~ ns(log_mg_d_L), S = vmd,
     random =  ~ log_mg_d_L | Ref/Comparison")
abline(0,0)

new_resid_b_b2 <- resid(log_mod_SS_fertil_b_NL6b)
new_fitted_b_b2 <- fitted(log_mod_SS_fertil_b_NL6b)
plot(new_fitted_b_b2, new_resid_b_b2, main = "B2: smd ~ ns(log_mg_d_L), control = addSlist,
     random =  ~ ns(log_mg_d_L) | Ref/Comparison")
abline(0,0)
#log_mod_SS_fertil_b_2b has slightly lower AIC but residuals much more extreme in magnitude

new_resid_d_b <- resid(log_mod_SS_fertil_b_NL3d_2)
new_fitted_d_b <- fitted(log_mod_SS_fertil_b_NL3d_2)
plot(new_fitted_d_b, new_resid_d_b, main = "D: smd ~ ns(log_mg_L), S = vmd,
     random =  ~ log_mg_L | Ref_name/Comparison")
abline(0,0)

new_resid_d_b2 <- resid(log_mod_SS_fertil_b_NL2d_2)
new_fitted_d_b2 <- fitted(log_mod_SS_fertil_b_NL2d_2)
plot(new_fitted_d_b2, new_resid_d_b2, main = "D2: smd ~ ns(log_mg_L), S = vmd,
     random =  ~ log_mg_L | Ref/Comparison")
abline(0,0)
...
qqnorm(new_resid_b_b2)
qqline(new_resid_b_b2)
qqnorm(new_resid_d_b)
qqline(new_resid_d_b)
qqnorm(new_resid_d_b2)
qqline(new_resid_d_b2)
par(op)


# Patterns:
# 1.  Very similar to residuals for linear models, so no complaints!
```
...
```{r, echo=FALSE, warning=FALSE}
summary(log_mod_SS_fertil_b_6b)

# PREDICT THE EFFECT SIZE AND PLOT WITH CONFIDENCE INTERVALS
pred_log_mod_SS_fertil_b_6b <- predict(log_mod_SS_fertil_b_6b, newdata=ES_SS_fertilization_b2, ci=TRUE)
ES_SS_fertilization_b2_CI2 <- cbind(ES_SS_fertilization_b2, pred_log_mod_SS_fertil_b_6b)
#head(ES_SS_fertilization_b2_CI2)
min_exp_b <- ES_SS_fertilization_b2_CI2 %>% 
  mutate(overlap0 = 0 >= ci.lb & 0 <= ci.ub) %>% 
  filter(overlap0==FALSE) %>% 
  filter(ci.ub<0) %>% 
  summarize(min_exp_b=min(Sed_exposure_mg_d_L))
...
ggplot(ES_SS_fertilization_b2_CI2, 
       aes(x = Sed_exposure_mg_d_L,
           y = smd,
           color = Ref,
           ymin = smd-vmd,
