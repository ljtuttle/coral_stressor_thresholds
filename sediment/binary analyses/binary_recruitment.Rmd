...
modSS2 <- glmer(Binary_recruit_death ~ Sed_level_stand_mg + (1 | Gsp), 
              family = binomial, data = recruitSS2)
#singular
#modSS2b <- glmer(Binary_recruit_death ~ Sed_level_stand_mg + #Coral_age_at_start_expt_days_since_settled + (1 | Gsp), 
#              family = binomial, data = recruitSS2)
